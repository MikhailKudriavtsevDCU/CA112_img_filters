...
def apply_sharpen_effect(input_image_path, output_image_path):
    try:
        ...
        print(f"Sharpening effect applied and saved to {output_image_path}")
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python sharpen_effect.py <input_image> <output_image>")
        sys.exit(1)

    input_image_path = sys.argv[1]
    output_image_path = sys.argv[2]
    apply_sharpen_effect(input_image_path, output_image_path)
